...
import ForgotPasswordComponent from './forgotPassword.components/forgotPassword.component';
...
const LoginCard = () => {
    ...
    useEffect(() => {
        const handleEscape = (e) => {
            if (e.key === 'Escape' && forgotPasswordOpened) {
                setForgotPasswordOpened(false);
            }
        };

        if (forgotPasswordOpened) {
        ...
        <>
            {forgotPasswordOpened && (
                <ForgotPasswordComponent
                    show={forgotPasswordOpened}
                    togglePopup={() => setForgotPasswordOpened(false)}
                />
            )}
                        ...
                        <div className="space-y-4">
                            ...
                            >
                                <button
                                    ...
                                    disabled={isLoading}
                                    className="flex cursor-pointer items-center justify-center px-3 py-2.5 border border-gray-200 rounded-lg hover:bg-gradient-to-r hover:from-[#00B6C7]/5 hover:to-[#00FF99]/5 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed hover:border-[#00B6C7]/30 hover:scale-105 hover:shadow-lg"
                                >
                                ...
                                <button
                                    ...
                                    className="flex cursor-pointer items-center justify-center px-3 py-2.5 border border-gray-200 rounded-lg hover:bg-gradient-to-r hover:from-[#00B6C7]/5 hover:to-[#00FF99]/5 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed hover:border-[#00B6C7]/30 hover:scale-105 hover:shadow-lg"
                                >
                                    <Facebook className="w-4 h-4 text-gray-600 mr-2 transition-colors duration-300 group-hover:text-[#0D9AAC]" />
