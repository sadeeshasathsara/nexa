        ...
        <div className="space-y-6">
            ...
            <label className="flex items-start gap-3 cursor-pointer group">
                <div className="relative flex-shrink-0 mt-0.5">
                    <input
                        type="checkbox"
                        checked={formData.tnc || false}
                        onChange={(e) => setFormData({ ...formData, tnc: e.target.checked })}
                        className="sr-only"
                    />
                    <div className={`w-5 h-5 rounded border-2 transition-all duration-200 ${formData.tnc
                ...
                <span className="text-sm text-gray-700 leading-relaxed">
                    I agree to the <span className="text-indigo-600 font-semibold">Terms and Conditions</span> and
            ...
            <div className="flex gap-3">
                ...
                <button
                    ...
                    disabled={!formData.tnc || isSubmitting}
