  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-gray-50 rounded-xl p-4 max-h-40 overflow-y-auto text-sm text-gray-600 space-y-2">
        ...
        <p>
          NEXA provides tools for students, tutors, institutions, and donors to
          connect and learn in a safe environment.
        </p>
        <p>
          You are responsible for the information you share, your interactions
          with others, and complying with all rules. Misuse of the platform may
