...
const Navbar = () => {
    ...
    const navigationItems = [
        ...
        { name: 'Courses', icon: BookOpen, path: '/courses', badge: 'New' },
        { name: 'My Classes', icon: Play, path: '/sessions', badge: null },
    ...
    return (
        <>
            ...
            <nav className="bg-white shadow-lg border-b border-gray-100 top-0 z-50 backdrop-blur-sm bg-white/95">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex items-center justify-between h-16">

                        {/* Logo Section */}
                        <div className="flex-shrink-0 flex items-center" onClick={() => handleNavItemClick('Dashboard')}>
                            <div className="h-15 w-[150px] flex items-center cursor-pointer">
                                <img
                                    src={Logo}
                                    alt="Logo"
                ...
                <div className={`fixed inset-y-0 left-0 transform ${isMenuOpen ? 'translate-x-0' : '-translate-x-full'} w-80 bg-white shadow-2xl transition-transform duration-300 ease-in-out z-50 md:hidden`}>
