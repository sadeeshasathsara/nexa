      ...
      <div className="p-4 flex flex-col">
        ...
        <div className="h-8 flex items-center justify-between">
          ...
          <button
            ...
            className="bg-gradient-to-r cursor-pointer bg-[#00c951] hover:bg-[#02aa45] text-white text-sm font-semibold px-5 py-2 rounded-full shadow-md hover:shadow-lg transform hover:scale-102 transition-all duration-300"
          >
            Enroll Now
          </button>
        </div>
